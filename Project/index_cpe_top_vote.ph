...
<div class="con">
   ...
   <div class="logo"><div class="login_bar"> 
          ...
          <div class="main_content" id="main_content">
                ...
                <div class="app_top_vote" id="app_top_vote"> 
                    <div class="name_top_vote_index">คะแนนมากที่สุด</div>
                        ...
                        <?php
                            ...
                            ");	
                                        ...
                                        $db->close();
                            ?>
                    <div class="show_all_top_vote"><a href="index_cpe_top_vote.php">ชมทั้งหมด</a></div>
                </div>
