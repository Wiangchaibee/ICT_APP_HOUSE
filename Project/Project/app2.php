...
$_SESSION['detail'] = $_SESSION['search2']->list_item[$_POST['index']]->app_detail;
$_SESSION['logo'] = $_SESSION['search2']->list_item[$_POST['index']]->app_logo;
$_SESSION['scr_1'] = $_SESSION['search2']->list_item[$_POST['index']]->app_scr_1 ;
$_SESSION['scr_2'] = $_SESSION['search2']->list_item[$_POST['index']]->app_scr_2 ;		 
$_SESSION['scr_3'] = $_SESSION['search2']->list_item[$_POST['index']]->app_scr_3 ;
$_SESSION['app_name'] = $_SESSION['search2']->list_item[$_POST['index']]->app_name ;
$_SESSION['app_system'] = $_SESSION['search2']->list_item[$_POST['index']]->app_system ;
$_SESSION['app_version'] = $_SESSION['search2']->list_item[$_POST['index']]->app_version ;
$_SESSION['app_doc_load'] = $_SESSION['search2']->list_item[$_POST['index']]->app_doc_load ;
$_SESSION['app_file_load'] = $_SESSION['search2']->list_item[$_POST['index']]->app_file_load ;
$_SESSION['app_view'] = $_SESSION['search2']->list_item[$_POST['index']]->app_view ;
$_SESSION['app_file'] = $_SESSION['search2']->list_item[$_POST['index']]->app_path ;
$_SESSION['app_doc'] = $_SESSION['search2']->list_item[$_POST['index']]->app_doc;
$_SESSION['app_clip'] = $_SESSION['search2']->list_item[$_POST['index']]->app_clip ;
$_SESSION['app_field'] = $_SESSION['search2']->list_item[$_POST['index']]->app_field ;
$_SESSION['app_tag'] = $_SESSION['search2']->list_item[$_POST['index']]->app_tag ;
$_SESSION['app_vote_avg'] = $_SESSION['search2']->list_item[$_POST['index']]->app_vote_avg ;
