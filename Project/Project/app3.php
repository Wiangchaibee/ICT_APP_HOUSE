            	...
            	<tr>
                	<td id="o_t_left">
                    	<div id="over1">
                            ...
                            <div id="tag" style="margin-left:-270px; margin-top:2px;">คะแนน :</div><div id="star_vote4" style="margin-top:2px; margin-left:2px;" data-rating="<? echo $_SESSION['app_vote_avg']; ?>" id="tag" ></div>
