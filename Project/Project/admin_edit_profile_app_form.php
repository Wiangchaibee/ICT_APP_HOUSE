...
<form id="edit_app_group" name="edit_app_group"  enctype="multipart/form-data" action="profile_app_update.php" method="post" >
    ...
    <?php for($o=1;$o<=$row[0];$o++){ ?>
      ...
      <tr>
        ...
        <tr>
        <td>อาจารย์ที่ปรึกษาคนที่1 </td><td><select name="advisor_1" id="advisor_1"><?php
			if( $id_advisor_1 != '')
      ...
      <tr>
        ...
        <tr>
            <td>ชื่อแอปพลิเคชั่น</td>
            <td colspan=2><input type="text" name="app_name" id="app_name" value= <?php  echo $app_name; ?> 
                        />
         </tr>
       ...
       <tr>
       <tr>
        <td>ไฟล์เอกสารที่เกี่ยวกับแอปลิเคชั่น</td>
            ...
            <td>ประเภท</td>
                    ...
                    <select name="app_tag" id="app_tag">
                        <?php
                                        ...
                                        if($app_tag == 'เกม'){
											 Echo "<option value=\"".เกม."\"selected=\"selected\">".เกม."</option>";
										?>  
										...
										}if($app_tag == 'ความบันเทิง'){                
                                             Echo "<option value=\"".ความบันเทิง."\"selected=\"selected\">".ความบันเทิง."</option>";
										...
										<option value="อื่นๆ">อื่นๆ</option>; <?php
                                             ...
                                             Echo "<option value=\"".การศึกษา."\"selected=\"selected\">".การศึกษา."</option>";	 
											 ?>   <option value="เกม">เกม</option>;
                                        <option value="ความบันเทิง">ความบันเทิง</option>;
                                        <option value="สังคมและการสื่อสาร">สังคม และสื่อสาร</option>;
                                        <option value="ดนตรีและเสียงเพลง">ดนตรี และเสียงเพลง</option>;
                                        <option value="เครื่องมือ">เครื่องมือ</option>;
                                        <option value="อื่นๆ">อื่นๆ</option>; <?php
									 	}if($app_tag == 'สังคมและการสื่อสาร'){
											 Echo "<option value=\"".สังคมและการสื่อสาร."\"selected=\"selected\">".สังคม."".และสื่อสาร."</option>";
											  ?>   <option value="เกม">เกม</option>;
                                        <option value="ความบันเทิง">ความบันเทิง</option>;
                                        <option value="การศึกษา">การศึกษา</option>;
                                        <option value="ดนตรีและเสียงเพลง">ดนตรี และเสียงเพลง</option>;
                                        <option value="เครื่องมือ">เครื่องมือ</option>;
                                        <option value="อื่นๆ">อื่นๆ</option>; <?php
										}if($app_tag == 'ดนตรีและเสียงเพลง'){               
                                             Echo "<option value=\"".ดนตรีและเสียงเพลง."\"selected=\"selected\">".ดนตรี."".และเสียงเพลง."</option>";	
											   ?>  <option value="เกม">เกม</option>;
                                        <option value="ความบันเทิง">ความบันเทิง</option>;
                                        <option value="การศึกษา">การศึกษา</option>;
                                        <option value="สังคมและการสื่อสาร">สังคม และสื่อสาร</option>;
                                        <option value="เครื่องมือ">เครื่องมือ</option>;
                                        <option value="อื่นๆ">อื่นๆ</option>; <?php	 
										}if($app_tag == 'เครื่องมือ'){                
                                             Echo "<option value=\"".เครื่องมือ."\"selected=\"selected\">".เครื่องมือ."</option>";
											 	?>   <option value="เกม">เกม</option>;
                                        <option value="ความบันเทิง">ความบันเทิง</option>;
                                        <option value="การศึกษา">การศึกษา</option>;
                                        <option value="สังคมและการสื่อสาร">สังคม และสื่อสาร</option>;
                                        ...
                                        <option value="อื่นๆ">อื่นๆ</option>;
										 <?php
                                             ...
                                             Echo "<option value=\"".อื่นๆ."\"selected=\"selected\">".อื่นๆ."</option>";	
											 	?>   <option value="เกม">เกม</option>;
                                        <option value="ความบันเทิง">ความบันเทิง</option>;
                                        <option value="การศึกษา">การศึกษา</option>;
                                        <option value="สังคมและการสื่อสาร">สังคม และสื่อสาร</option>;
        ...
        <tr>
               <td>คลิป</td>
            	<td colspan="2"><textarea type="text" name="clip_show" id="clip_show" rows="2" cols="25">http://youtube.be/<?php echo $app_clip; ?></textarea>
                 </td>
            </td>
        </tr>																								
        ...
        <tr>
     	...
     	<td>วันที่อัพโหลดแก้ไข<a style="color:#FF0000;">*</a></td>
              ...
              <input type="hidden" name="num11" value="<?php echo $nn; ?>"/>
            <div class="button">
                <input type="button" value="ตกลง" onclick="edit_profile_app_admin();"/>
