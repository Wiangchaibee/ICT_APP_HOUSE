...
<div class="con">
   ...
   <div class="logo"><div class="login_bar"> 
          ...
          <div class="main_content" id="main_content">
           	...
           	<table id="top">
            	<tr>
                        <td id="top1"><img src="img/top_view.png" /></td>
                </tr>
				...
				<tr>
                            <td id="top2"><?php
                                ...
                                WHERE `app_tag` = 'ความบันเทิง' 
                                ORDER BY app_view DESC LIMIT 4
                                ");	
    
                                            $_SESSION['search'] = new app_list($res);
                                            print_r ($_SESSION['search']->get_page_index(1));
                                            $db->close();
                                ?></td>
                </tr>
                ...
                <tr>
                        ...
                        <td id="top3"><a href="index_entertain_top_view.php">ชมทั้งหมด</a></td>
                </tr>
                ...
                <tr>
                       ...
                       <td id="top2"> <?php
                            ...
                            "SELECT * FROM `project` . `application`
                            WHERE `app_tag` = 'ความบันเทิง' 
                            ORDER BY app_vote_avg DESC LIMIT 4
                            ");	
                    ...
                    <tr><td id="top3"><a href="index_entertain_top_vote.php">ชมทั้งหมด</a></td></tr>
                </table>
                 ...
                 <tr>
                        <td id="top2"><?php
                            ...
                            "SELECT * FROM `project` . `application`
                            WHERE `app_tag` = 'ความบันเทิง' 
                            ORDER BY app_time DESC LIMIT 4
                            ");	
                 ...
                 <tr>
                   <td id="top3"><a href="index_entertain_new.php">ชมทั้งหมด</a></td>
                 </tr>
               </table>
