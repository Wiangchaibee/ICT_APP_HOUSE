          ...
          <div class="main_content" id="main_content">
            ...
            <tr>
            			...
            			<td id="top2"><?php
							...
							WHERE `app_tag` = 'สังคมและการสื่อสาร' 
            ...
            <tr>
                    <td id="top3"><a href="index_app_top_view.php">ชมทั้งหมด</a></td>
            </tr>
            </table>
           ...
           <table id="top"> 
            ...
            <tr>
                    <td id="top3"><a href="index_app_top_vote.php">ชมทั้งหมด</a></td>
            </tr>
            </table>
            ...
            <tr>
                    <td id="top3"><a href="index_app_new.php">ชมทั้งหมด</a></td>
            </tr>
            </table>
