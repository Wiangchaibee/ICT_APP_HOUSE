         ...
         <table id="top">
				...
				<tr>
                            <td id="top2"><?php
                                ...
                                WHERE `app_tag` = 'ดนตรีและเสียงเพลง' 
                ...
                <tr>
                        ...
                        <td id="top3"><a href="index_music_top_view.php">ชมทั้งหมด</a></td>
                </tr>
                ...
                <tr>
                    ...
                    <tr><td id="top3"><a href="index_music_top_vote.php">ชมทั้งหมด</a></td></tr>
                </table>
                 ...
                 <tr>
                   <td id="top3"><a href="index_music_new.php">ชมทั้งหมด</a></td>
                 </tr>
               </table>
