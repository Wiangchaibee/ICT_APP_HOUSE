...
$_SESSION['search3']->list_item[$_POST['index']]->app_view();
$_SESSION['viewing_app_id'] = $_SESSION['search3']->list_item[$_POST['index']]->app_id;
$_SESSION['item_index'] = $_POST['index'];
$_SESSION['com_list'] = new comment_list($_SESSION['viewing_app_id']);
$_SESSION['detail'] = $_SESSION['search3']->list_item[$_POST['index']]->app_detail;
$_SESSION['logo'] = $_SESSION['search3']->list_item[$_POST['index']]->app_logo;
$_SESSION['scr_1'] = $_SESSION['search3']->list_item[$_POST['index']]->app_scr_1 ;
$_SESSION['scr_2'] = $_SESSION['search3']->list_item[$_POST['index']]->app_scr_2 ;		 
$_SESSION['scr_3'] = $_SESSION['search3']->list_item[$_POST['index']]->app_scr_3 ;
$_SESSION['app_name'] = $_SESSION['search3']->list_item[$_POST['index']]->app_name ;
$_SESSION['app_email'] = $_SESSION['search3']->list_item[$_POST['index']]->app_email ;
$_SESSION['app_system'] = $_SESSION['search3']->list_item[$_POST['index']]->app_system ;
$_SESSION['app_version'] = $_SESSION['search3']->list_item[$_POST['index']]->app_version ;
$_SESSION['app_doc_load'] = $_SESSION['search3']->list_item[$_POST['index']]->app_doc_load ;
$_SESSION['app_file_load'] = $_SESSION['search3']->list_item[$_POST['index']]->app_file_load ;
$_SESSION['app_view'] = $_SESSION['search3']->list_item[$_POST['index']]->app_view ;
$_SESSION['app_file'] = $_SESSION['search3']->list_item[$_POST['index']]->app_path ;
$_SESSION['app_doc'] = $_SESSION['search3']->list_item[$_POST['index']]->app_doc;
$_SESSION['app_clip'] = $_SESSION['search3']->list_item[$_POST['index']]->app_clip ;
$_SESSION['app_field'] = $_SESSION['search3']->list_item[$_POST['index']]->app_field ;
$_SESSION['app_tag'] = $_SESSION['search3']->list_item[$_POST['index']]->app_tag ;
$_SESSION['app_vote_avg'] = $_SESSION['search3']->list_item[$_POST['index']]->app_vote_avg ;
            	...
            	<tr>
                	<td id="o_t_left">
                    	<div id="over1">
                            ...
                            <div id="tag" style="margin-left:-270px; margin-top:2px;">คะแนน :</div><div id="star_vote4" style="margin-top:2px; margin-left:2px;" data-rating="<?php echo $_SESSION['app_vote_avg']; ?>" id="tag" ></div>
                            ...
                            <div id="download1"  style="margin-left:315px; margin-top:-28px; width:30px;" onclick="get_download_file(<? echo $_SESSION['viewing_app_id']; ?>);"><a href="<?php echo $_SESSION['app_file']; ?>" ><img src="img/download.jpg" style="width:30px; height:30px;"  /></a></div>
                            <div id="download"  style="margin-left:280px; margin-top:-32px; width:30px;"  onclick="get_download_doc(<?php echo $_SESSION['viewing_app_id']; ?>);"><a href="<?php echo $_SESSION['app_doc']; ?>"><img src="img/download_doc.gif" style="width:30px; height:30px;"   /></a></div>
                            <?php }
							else{ ?>
                    ...
                    <td id="o_t_right">
                    	<br /><div id="detail" >
                        	<div id="detail2" style="font-weight:bold; font-size:14px; color:#000000;">รายละเอียดเกี่ยวกับแอปพลิเคชั่น</div>
                            	...
                            	<div id="slides" style="position:absolute;top:205px;left:405px;z-index:100;">
        ...
        <div id="review_tab">
                ...
                <tr>
           		...
           		<td id="r_t_left">
                               ...
                               <?php }else{  ?>  <div id="v1"><br /><br /><div id="vote" ></div>Vote:<div id="vote_text" ></div></div>  
                ...
                <td id="r_t_right">
                       ...
                       <div style="margin-left:5px; margin-top:4px; color:#660066; font-weight:bold;"><?php print_r ("APP_ID".$_SESSION['search']->list_item[$_POST['index']]->app_id);	?></div><br />
